<template>
  <div class="pref-spellchecker">
    <h4>{{ $t('spellchecker.title') }}</h4>
    <compound>
      <template #head>
        <bool
          :description="$t('spellchecker.settings.enabled')"
      ...
      <template #children>
        <bool
          :description="$t('spellchecker.settings.noUnderline')"
        ...
        <cur-select
          v-show="!isOsx"
          :description="$t('spellchecker.settings.language')"
