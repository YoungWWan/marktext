...
export default function (keybindings) {
  return {
    ...
    submenu: [{
      ...
      label: t('paragraph.promoteHeading'),
      ...
      label: t('paragraph.demoteHeading'),
      ...
      label: t('paragraph.looseListItem'),
      type: 'checkbox',
      ...
      label: t('paragraph.horizontalLine'),
      type: 'checkbox',
